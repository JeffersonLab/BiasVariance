...
#set label 28 "{\\tiny \\color[rgb]{1,0,0} $(\\sigma)$}" at 0.758+offset,25.6+6.1+1 rotate by 0 right
...
set label 31 "{\\tiny \\color[rgb]{0,0.5,0} $(\\sigma)$}" at 0.758+offset,34.5+1 rotate by 0 right
...
plot "CODATA12.dat" using (0.8751):(20.0):(0.0051):(20.0) w boxxy lc rgb "#FF6600" lt 1 notitle,\
	...
	"" using (0.84184):(33):(0.00067) w xerrorbars pt 5 lt 1  lc rgb "#FF6666" notitle,\
	"" using (0.84087):(34):(0.00039) w xerrorbars pt 5 lc 1 ps 2 lt 1 lw 4 notitle,\
	"" using (0.8356):(36):(0.0020) w xerrorbars pt 15 ps 2 lt 1 lw 4  lc rgb "#008800" notitle,\
