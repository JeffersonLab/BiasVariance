...
one set of pseudo data, with absolute 0.3\% random point-to-point uncertainty and 0.01 fm$^{-2}$ spacing,
...
Along with the data, four represenative functions are shown using Eq.~\ref{Eq:CrossSection} with a standard magnetic form factor and
...
We note that this figure looks oddly similiar to the psuedo data in Fig.~\ref{linearVSquadratic} but here the true function is an unknown 
so it is not clear how far or which curves are shifted with respeect to the true reduced cross section values.

\begin{figure}
\includegraphics[width=\columnwidth]{Figure/RealData.pdf} 
\caption{Shown is one set of modern cross section data to illistrate the current tension between 
...
13$^{th}$ order polynimial with a radius of 0.88~fm~\cite{Ye:2017gyb}, a unbounded 10$^{th}$ order polynimal with a radius of 0.88~fm~\cite{Bernauer:2013tpr}, 
...
To avoid floating multiple normalizations, the set of 104 data points shown in Fig.~\ref{RealData} is used.
...
linear    & 1.187     & 19.82  & 25.11  & 1.001(1)    & 0.853(2)   \\
quadratic & 1.173     & 19.52  & 27.45  & 0.998(2)    & 0.837(10)  \\
...
quadratic & 1.183     & 20.43  & 28.37 & 1.000(4)        & 0.854(10)    \\ 
cubic     & 1.173     & 20.55  & 31.13        & 0.992(6)        & 0.785(56)    \\ 
...
quadratic & 1.182     & 20.33  & 28.26 & 1.000(2)      & 0.852(10)     \\
cubic     & 1.173     & 20.55  & 31.12 & 0.992(6)  & 0.782(55)    \\ 
